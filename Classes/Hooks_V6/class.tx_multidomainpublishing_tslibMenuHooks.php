 ...
 */
class tx_multidomainpublishing_tslibMenuHooks implements \TYPO3\CMS\Core\SingletonInterface, \TYPO3\CMS\Frontend\ContentObject\Menu\AbstractMenuFilterPagesHookInterface {
	 ...
	 * @param	\TYPO3\CMS\Frontend\ContentObject\Menu\AbstractMenuContentObject	The menu object
	 * @return	boolean		Returns true if the page can be safely included.
	 */
	public function processFilter(array &$data, array $banUidArray, $spacer, \TYPO3\CMS\Frontend\ContentObject\Menu\AbstractMenuContentObject $ref){
	 ...
	 * @return	boolean		Returns true if the page can be safely included.
	 */
	public function tslib_menu_filterMenuPagesHook (array &$data, array $banUidArray, $spacer, \TYPO3\CMS\Frontend\ContentObject\Menu\AbstractMenuContentObject $ref){
